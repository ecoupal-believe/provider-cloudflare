...
PROJECT_REPO ?= github.com/ecoupal-believe/provider-upjet-cloudflare

export TERRAFORM_VERSION ?= 1.5.5
export TERRAFORM_PROVIDER_VERSION := 4.27.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-cloudflare_v4.27.0
